package edu.sebsx.app.linkedlist.circular.doubly;
...
public class DoublyCircularLinkedList<E> extends AbstractList<E> {
  ...
  public E[] peekArray(int n) {
    ...
    DoubleLinkedNode<E> curr = this.head;
  ...
  public E[] peekLastArray(int n) {
    ...
    int limit = (n > this.size) ? this.size : n;
    E[] res = (E[]) new Object[limit];
    DoubleLinkedNode<E> curr = this.tail;
  ...
  public List<E> peekCollection(int n) {
    DoublyCircularLinkedList<E> list = new DoublyCircularLinkedList<>();
  ...
  public boolean remove(E element) {
    ...
    for (int i = 0; i < this.size; i++) {
      if (curr.get().equals(element)) {
        if (curr == this.head) this.poll();
        else if (curr == this.tail) this.pollLast();
        else {
  ...
  public List<E> subList(E from, E to) {
    DoublyCircularLinkedList<E> sub = new DoublyCircularLinkedList<>();
    DoubleLinkedNode<E> curr = this.head;
