...
public class LoginView extends javax.swing.JFrame {
    ...
    private void registerUserFlow() {
        ...
        javax.swing.JComboBox<String> cmbRole = new javax.swing.JComboBox<>(
                new String[] { "ADMIN", "OPERATOR", "STANDARD_USER" });
        ...
        int result = javax.swing.JOptionPane.showConfirmDialog(this, panel, "Registrar Usuario",
                ...
                registerHandler.accept(new Object[] { id, user, pass, role, name, lastName }, success -> {
                    if (success) {
                        ...
                        javax.swing.JOptionPane.showMessageDialog(this,
                                "Error al registrar (el usuario ya existe o error RMI).");
                    }
                });
            }
        }
